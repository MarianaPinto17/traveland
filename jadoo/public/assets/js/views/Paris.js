        ...
        <div class="container">
            ...
            <div class="py-4 px-0 position-relative text-center mt-4" style="background-color: rgba(235, 149, 149, 0.199);">
              <div class="row justify-content-center">
                <div class="col-sm-2">
                  <h2 class="hero-title-2" style="font-size: 30px;">Paris, France</h2>
                  <img class="card-img" src="assets/img/dest/paris.jpg" alt="Paris, France" style="width: 150px;";/>
                </div>
                ...
                <div class="col-sm-3">
                  <span>from <span class="hero-title-2" style="font-size:50px;">3420€</span></span>
                  <br>
            ...
            <div class="py-4 px-0 position-relative text-center mb-4 mt-4" style="background-color: rgba(235, 149, 149, 0.199);">
              <div class="row justify-content-center">
                <div class="col-sm-2">
                  <h2 class="hero-title-2" style="font-size: 30px;">Paris, France</h2>
                  <img class="card-img" src="assets/img/dest/paris2.jpg" alt="Paris, France" style="width: 130px;";/>
                </div>
                <div class="col-sm-6" style="margin-top: 50px;">
                  <div class="icon-group mb-2"> 
                    <span class="icon-indicator"> 
            ...
            <div class="py-4 px-0 position-relative text-center mb-4" style="background-color: rgba(235, 149, 149, 0.199);">
              <div class="row justify-content-center">
                <div class="col-sm-2">
                  <h2 class="hero-title-2" style="font-size: 30px;">Paris, France</h2>
                  <img class="card-img" src="assets/img/dest/paris3.jpg" alt="Paris, France" style="width: 130px;";/>
                </div>
                <div class="col-sm-6" style="margin-top: 50px;">
                  <div class="icon-group mb-2"> 
                    <span class="icon-indicator"> 
