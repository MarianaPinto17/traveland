        ...
        <div class="container">
            ...
            <div class="py-4 px-0 position-relative text-center mt-4" style="background-color: rgba(235, 149, 149, 0.199);">
              <div class="row justify-content-center">
                <div class="col-sm-2">
                  <h2 class="hero-title-2" style="font-size: 30px;">London, UK</h2>
                  <img class="card-img" src="assets/img/dest/london.jpg" alt="London, UK" style="width: 150px;";/>
                </div>
                ...
                <div class="col-sm-3">
                  <span>from <span class="hero-title-2" style="font-size:50px;">2200€</span></span>
                  <br>
            ...
            <div class="py-4 px-0 position-relative text-center mb-4 mt-4" style="background-color: rgba(235, 149, 149, 0.199);">
              <div class="row justify-content-center">
                <div class="col-sm-2">
                  <h2 class="hero-title-2" style="font-size: 30px;">London, UK</h2>
                  <img class="card-img" src="assets/img/dest/london2.jpg" alt="London, UK" style="width: 130px;";/>
                </div>
                <div class="col-sm-6" style="margin-top: 50px;">
                  <div class="icon-group mb-2"> 
                    <span class="icon-indicator"> 
                ...
                <div class="col-sm-3">
                  <span>from <span class="hero-title-2" style="font-size:50px;">1500€</span></span>
                  <br>
                  <h8 class="fs-0 fw-lighter" style="text-align: left; margin-left: 30px;"> Not included airport and cities fees.</h8>
                  <br>
                  <a href="contact.html" class="btn btn-success mb-4 mt-4" style="width: 250px; font-size: 20px; text-transform: uppercase; font-weight: bold;">Book</a>
            ...
            <div class="py-4 px-0 position-relative text-center mb-4" style="background-color: rgba(235, 149, 149, 0.199);">
              <div class="row justify-content-center">
                <div class="col-sm-2">
                  <h2 class="hero-title-2" style="font-size: 30px;">London, UK</h2>
                  <img class="card-img" src="assets/img/dest/london3.jpg" alt="London, UK" style="width: 130px;";/>
                </div>
                <div class="col-sm-6" style="margin-top: 50px;">
                  <div class="icon-group mb-2"> 
                    <span class="icon-indicator"> 
                ...
                <div class="col-sm-3">
                  <span>from <span class="hero-title-2" style="font-size:50px;">1800€</span></span>
                  <br>
                  <h8 class="fs-0 fw-lighter" style="text-align: left; margin-left: 30px;"> Not included airport and cities fees.</h8>
                  <br>
                  <a href="contact.html" class="btn btn-success mb-4 mt-4" style="width: 250px; font-size: 20px; text-transform: uppercase; font-weight: bold;">Book</a>
            ...
            <div class="py-4 px-0 position-relative text-center mb-4" style="background-color: rgba(235, 149, 149, 0.199);">
              <div class="row justify-content-center">
                <div class="col-sm-2">
                  <h2 class="hero-title-2" style="font-size: 30px;">London, UK</h2>
                  <img class="card-img" src="assets/img/dest/london4.jpg" alt="London, UK" style="width: 130px;";/>
                </div>
                <div class="col-sm-6" style="margin-top: 50px;">
                  <div class="icon-group mb-2"> 
                    <span class="icon-indicator"> 
                ...
                <div class="col-sm-3">
                  <span>from <span class="hero-title-2" style="font-size:50px;">900€</span></span>
                  <br>
                  <h8 class="fs-0 fw-lighter" style="text-align: left; margin-left: 30px;"> Not included airport and cities fees.</h8>
                  <br>
                  <a href="contact.html" class="btn btn-success mb-4 mt-4" style="width: 250px; font-size: 20px; text-transform: uppercase; font-weight: bold;">Book</a>
